...
/**
 * SearchFullTextPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Synerise\ItemsSearchApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SearchFullTextPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchFullTextPost_request';
    ...
    */
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 500)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchFullTextPostRequest., must be smaller than or equal to 500.');
        }
        if (($limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchFullTextPostRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setFacetsSize($facets_size)
    {
        ...
        if (($facets_size > 10000)) {
            throw new \InvalidArgumentException('invalid value for $facets_size when calling SearchFullTextPostRequest., must be smaller than or equal to 10000.');
        }
        if (($facets_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $facets_size when calling SearchFullTextPostRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxValuesPerFacet($max_values_per_facet)
    {
        ...
        if (($max_values_per_facet > 1000)) {
            throw new \InvalidArgumentException('invalid value for $max_values_per_facet when calling SearchFullTextPostRequest., must be smaller than or equal to 1000.');
        }
        if (($max_values_per_facet < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_values_per_facet when calling SearchFullTextPostRequest., must be bigger than or equal to 1.');
        }
