...
/**
 * FullTextSuggestionSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class FullTextSuggestionSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FullTextSuggestionSchema';
    ...
    */
     ...
     * Sets text
     *
     * @param string|null $text The suggested text query
     *
     * @return self
     */
     ...
     * Sets highlighted
     *
     * @param string|null $highlighted The suggested text query with the HTML emphasis tag added
     *
     * @return self
     */
     ...
     * Sets score
     *
     * @param float|null $score Estimated accuracy of the suggestion. `1.0` means 100%.
     *
     * @return self
     */
    public function setScore($score)
    {
        ...
        if (($score > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling FullTextSuggestionSchema., must be smaller than or equal to 1.0.');
        }
