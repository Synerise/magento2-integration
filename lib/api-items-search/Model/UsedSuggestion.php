...
/**
 * UsedSuggestion Class Doc Comment
 *
 * @category Class
 ...
 */
class UsedSuggestion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsedSuggestion';
    ...
    */
    ...
    public function setScore($score)
    {
        ...
        if (($score > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling UsedSuggestion., must be smaller than or equal to 1.0.');
        }
