<?php
/**
 * SearchVisualPostRequest1Params
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SearchVisualPostRequest1Params Class Doc Comment
 *
 * @category Class
 ...
 */
class SearchVisualPostRequest1Params implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchVisualPost_request_1_params';
    ...
    */
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 500)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchVisualPostRequest1Params., must be smaller than or equal to 500.');
        }
        if (($limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchVisualPostRequest1Params., must be bigger than or equal to 0.');
        }
    ...
    public function setFacetsSize($facets_size)
    {
        ...
        if (($facets_size > 10000)) {
            throw new \InvalidArgumentException('invalid value for $facets_size when calling SearchVisualPostRequest1Params., must be smaller than or equal to 10000.');
        }
        if (($facets_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $facets_size when calling SearchVisualPostRequest1Params., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxValuesPerFacet($max_values_per_facet)
    {
        ...
        if (($max_values_per_facet > 1000)) {
            throw new \InvalidArgumentException('invalid value for $max_values_per_facet when calling SearchVisualPostRequest1Params., must be smaller than or equal to 1000.');
        }
        if (($max_values_per_facet < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_values_per_facet when calling SearchVisualPostRequest1Params., must be bigger than or equal to 1.');
        }
