<?php
/**
 * AutocompleteResponseWithQueryExtras
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AutocompleteResponseWithQueryExtras Class Doc Comment
 *
 * @category Class
 ...
 */
class AutocompleteResponseWithQueryExtras implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutocompleteResponseWithQuery_extras';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('es_query', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['es_query'];
    }

    /**
     * Sets es_query
     *
     * @param object|null $es_query The last query sent to the Elastic Search.
     *
     * @return self
     */
    public function setEsQuery($es_query)
    {
        if (is_null($es_query)) {
            throw new \InvalidArgumentException('non-nullable es_query cannot be null');
        }
        $this->container['es_query'] = $es_query;
