...
namespace Synerise\CatalogsApiClient;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.synerise.com/catalogs';
    ...
    {
        $report  = 'PHP SDK (Synerise\CatalogsApiClient) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.synerise.com/catalogs",
