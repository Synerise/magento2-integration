...
class ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets total_count
     *
     * @param int|null $total_count The total number of matching values (key-value pairs; array items; objects) in the database
     *
     * @return self
     */
     ...
     * Sets request_time
     *
     * @param string|null $request_time The processing time of the request
     *
     * @return self
     */
