 ...
 */
class ItemBag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'item_bag';
     ...
     *
     * @param int|null $business_profile_id ID of the Business Profile that contains this catalog
     *
     * @return self
     */
     ...
     * Sets author
     *
     * @param string|null $author ID of the catalog's creator
     *
     * @return self
     */
     ...
     * Sets last_modified
     *
     * @param \DateTime|null $last_modified Last modification date
     *
     * @return self
     */
     ...
     * Sets creation_date
     *
     * @param \DateTime|null $creation_date Creation date
     *
     * @return self
     */
