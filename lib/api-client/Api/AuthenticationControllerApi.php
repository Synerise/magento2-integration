...
class AuthenticationControllerApi
{
     ...
     * URL: https://api.synerise.com/uauth
     * URL: https://api.geb.synerise.com/uauth
     *
     *
     * @throws \Synerise\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Synerise\ApiClient\Model\GetCurrentBusinessProfileUsingGET200Response
     */
     ...
     * @throws \Synerise\ApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Synerise\ApiClient\Model\GetCurrentBusinessProfileUsingGET200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrentBusinessProfileUsingGETWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Synerise\ApiClient\Model\GetCurrentBusinessProfileUsingGET200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Synerise\ApiClient\Model\GetCurrentBusinessProfileUsingGET200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Synerise\ApiClient\Model\GetCurrentBusinessProfileUsingGET200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Synerise\ApiClient\Model\GetCurrentBusinessProfileUsingGET200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Synerise\ApiClient\Model\GetCurrentBusinessProfileUsingGET200Response',
     ...
     */
    public function getCurrentBusinessProfileUsingGETRequest()
    {
        ...
        $operationHosts = ["https://api.synerise.com/uauth", "https://api.geb.synerise.com/uauth"];
            ...
            switch($statusCode) {
                case 200:
                    if ('\Synerise\ApiClient\Model\TokenResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Synerise\ApiClient\Model\TokenResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
