<?php
/**
 * DistinctFilterAttributesSchema
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DistinctFilterAttributesSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class DistinctFilterAttributesSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistinctFilterAttributesSchema';
    ...
    */
     ...
     * Sets range
     *
     * @param string[] $range Array of range attributes
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string[] $text Array of text attributes
     *
     * @return self
     */
