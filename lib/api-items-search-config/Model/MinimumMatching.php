...
/**
 * MinimumMatching Class Doc Comment
 *
 * @category Class
 ...
 */
class MinimumMatching implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MinimumMatching';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value < 1)) {
            throw new \InvalidArgumentException('invalid value for $value when calling MinimumMatching., must be bigger than or equal to 1.');
        }
