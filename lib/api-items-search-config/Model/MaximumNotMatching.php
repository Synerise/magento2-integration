...
/**
 * MaximumNotMatching Class Doc Comment
 *
 * @category Class
 ...
 */
class MaximumNotMatching implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaximumNotMatching';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if (($value < 1)) {
            throw new \InvalidArgumentException('invalid value for $value when calling MaximumNotMatching., must be bigger than or equal to 1.');
        }
