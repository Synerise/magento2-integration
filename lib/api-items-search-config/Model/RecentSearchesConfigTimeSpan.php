...
/**
 * RecentSearchesConfigTimeSpan Class Doc Comment
 *
 * @category Class
 ...
 */
class RecentSearchesConfigTimeSpan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecentSearchesConfig_timeSpan';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type One of the following time units
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param int|null $value Value corresponding with the time unit
     *
     * @return self
     */
