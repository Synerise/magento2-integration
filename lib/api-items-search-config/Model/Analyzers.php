 ...
 */
class Analyzers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Analyzers';
    ...
    public const AUTOCOMPLETE_NGRAM = 'Ngram';
    public const AUTOCOMPLETE_EDGE_NGRAM = 'EdgeNgram';
    ...
    {
        return [
            self::AUTOCOMPLETE_NGRAM,
            self::AUTOCOMPLETE_EDGE_NGRAM,
        ];
    }
    ...
    */
     ...
     * Sets autocomplete
     *
     * @param string $autocomplete The completion method used.
     *
     * @return self
     */
