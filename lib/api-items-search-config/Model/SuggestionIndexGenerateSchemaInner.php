<?php
/**
 * SuggestionIndexGenerateSchemaInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SuggestionIndexGenerateSchemaInner Class Doc Comment
 *
 * @category Class
 * @package  Synerise\ItemsSearchConfigApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SuggestionIndexGenerateSchemaInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuggestionIndexGenerateSchema_inner';
    ...
    */
     ...
     *
     * @param string|null $items_catalog_id Id of a catalog from which attributes will be taken
     *
     * @return self
     */
