...
namespace Synerise\Integration\Search\Recommendation\NoResultsTop;
...
class Config implements ConfigInterface
{
    ...
    {
        return $this->dataStorage->get('noResultsTop/enabled', false);
    }
    ...
    {
        return $this->dataStorage->get('noResultsTop/header');
    }
}