...
namespace Synerise\Integration\Search\Recommendation\NoResults;
...
class Config implements ConfigInterface
{
    ...
    {
        return $this->dataStorage->get('noResults/enabled', false);
    }

    public function getCampaignId(): ?string
    {
        return $this->dataStorage->get('noResults/campaignId');
    }

    public function getHeader(): ?string
    {
        return $this->dataStorage->get('noResults/header');
    }
}