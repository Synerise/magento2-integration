...
namespace Synerise\Integration\Search\Recommendation\ZeroState;
...
class Config implements ConfigInterface
{
    ...
    {
        return $this->dataStorage->get('zeroState/enabled', false);
    }

    public function getCampaignId(): ?string
    {
        return $this->dataStorage->get('zeroState/campaignId');
    }

    public function getHeader(): ?string
    {
        return $this->dataStorage->get('zeroState/header');
    }
}