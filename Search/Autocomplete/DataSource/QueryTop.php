...
class QueryTop implements DataSourceInterface
{
    ...
    public function get(): ?DataInterface
    {
        ...
        $request = $this->getRequest($this->cookieHelper->getSnrsUuid(), $this->sourceConfig['limit']);
    ...
    protected function getRequest(?string $uuid = null, int $limit = 8): ListPostRequestBody
    {
