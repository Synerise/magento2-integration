...
class CustomerAdd
{
     ...
     */
    public function prepareRequestFromOrder(Order $order, ?string $uuid): CreateaClientinCRMRequest
    {
    ...
    public function prepareRequestFromReview(Review $review, string $uuid): CreateaClientinCRMRequest
    {
        return new CreateaClientinCRMRequest([
            'uuid' => $uuid,
